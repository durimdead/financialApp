...
{
    public class ExpenseRepoService_Postgres : IExpensesRepository
    {
        private readonly ILogger<IExpensesRepository> _logger;
        private readonly IExpenseDbContext _context;
        public ExpenseRepoService_Postgres(ILogger<IExpensesRepository> logger, IExpenseDbContext context)
        {
            _logger = logger;
            _context = context;
        }
